...
import { useCreateContactMutation } from '@/app/Store/apiSclice/Contact.ApiSlice';
...
const handleTwitterLink = () => window.open(twitterLink, '_blank', 'noopener,noreferrer');
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log(`Contect Created Successfully`, result);
            ...
            <div className="relative p-5 sm:p-6 md:p-8 bg-black/50 backdrop-blur-sm border-2 border-[#ceea45]/30 rounded-3xl">
              ...
              <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5 md:space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    name="reasionforcontact"
                    value={formData.reasionforcontact}
                    onChange={handleChange}
                    rows="5"
  ...
  type="submit"
  disabled={isLoading}
  className="gaming-button w-full py-3 sm:py-4 text-base sm:text-lg font-mono font-bold disabled:opacity-50 disabled:cursor-not-allowed"
>
  {isLoading ? (
    ...
    '[ TRANSMIT DATA ]'
              ...
              {/* Add this right after the closing </form> tag and before the closing form container div */}

{/* Success Message */}
{isSuccess && (
  <div className="mt-6 relative overflow-hidden">
    <div className="bg-gradient-to-r from-green-500/20 via-green-400/20 to-green-500/20 backdrop-blur-sm border-2 border-green-500/50 rounded-2xl p-4 sm:p-5 relative">
      ...
      <div className="flex items-center gap-3 relative z-10">
        {/* Success Icon */}
        <div className="w-10 h-10 sm:w-12 sm:h-12 bg-green-500/30 rounded-xl flex items-center justify-center flex-shrink-0 relative">
          <div className="pulse-dot absolute top-0 right-0 w-2 h-2 bg-green-400 rounded-full"></div>
        ...
        <div className="flex-1">
          <h3 className="text-green-400 font-mono text-sm sm:text-base font-bold mb-1">
            {'>'} TRANSMISSION_SUCCESSFUL
          </h3>
          <p className="text-green-300/80 text-xs sm:text-sm font-mono">
...
{isError && (
  <div className="mt-6 relative overflow-hidden">
    <div className="bg-gradient-to-r from-red-500/20 via-red-400/20 to-red-500/20 backdrop-blur-sm border-2 border-red-500/50 rounded-2xl p-4 sm:p-5 relative">
      {/* Animated background effect */}
      ...
      <div className="flex items-center gap-3 relative z-10">
        {/* Error Icon */}
        <div className="w-10 h-10 sm:w-12 sm:h-12 bg-red-500/30 rounded-xl flex items-center justify-center flex-shrink-0 relative">
          <div className="pulse-dot absolute top-0 right-0 w-2 h-2 bg-red-400 rounded-full"></div>
        ...
        <div className="flex-1">
          <h3 className="text-red-400 font-mono text-sm sm:text-base font-bold mb-1">
            {'>'} TRANSMISSION_FAILED
          </h3>
          <p className="text-red-300/80 text-xs sm:text-sm font-mono">
          ...
          >
            ...
            <div className="info-card p-4 sm:p-5 md:p-6 relative">
              <div className="flex items-start gap-3 sm:gap-4">
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-white text-sm sm:text-base md:text-lg font-semibold truncate">editcraft.co.in@gmail.com</p>
            ...
            <div className="info-card p-4 sm:p-5 md:p-6 relative">
              <div className="flex items-start gap-3 sm:gap-4">
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-white text-sm sm:text-base md:text-lg font-semibold">+91 9351659652</p>
            ...
            <div className="info-card p-4 sm:p-5 md:p-6 relative">
              <div className="flex items-start gap-3 sm:gap-4">
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-white text-sm sm:text-base md:text-lg font-semibold">India</p>
                  <p className="text-gray-400 text-xs sm:text-sm mt-1">Rajasthan, Jaipur</p>
                </div>
              </div>
            </div>
            ...
            <div className="info-card p-4 sm:p-5 md:p-6 relative">
              ...
              <div className="flex flex-wrap gap-3 sm:gap-4">
                <button onClick={handleFacebookLink}  className="social-button coursor-pointer">
                ...
                <button onClick={handleTwitterLink} className="social-button cursor-pointer">
                  <svg className="w-5 h-5 sm:w-6 sm:h-6 text-black" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723c-.951.555-2.005.959-3.127 1.184a4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z"/>
                  </svg>
                </button>
                <button onClick={handleInstagramLink} className="social-button cursor-pointer">
                  <svg className="w-5 h-5 sm:w-6 sm:h-6 text-black" fill="currentColor" viewBox="0 0 24 24">
                ...
                <button onClick={handleLinkedinLink} className="social-button cursor-pointer">
                  <svg className="w-5 h-5 sm:w-6 sm:h-6 text-black" fill="currentColor" viewBox="0 0 24 24">
