        ...
        <div className="relative z-10 p-5 sm:p-6 md:p-8 lg:p-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 mb-6 sm:mb-8">
            ...
            >
              ...
              <div className="flex gap-3 sm:gap-4 flex-wrap">
                <a href="#" className="social-icon w-10 h-10 sm:w-12 sm:h-12 rounded-xl border-2 border-white/20 flex items-center justify-center">
            ...
            >
              ...
              <ul className="space-y-2">
                <li><a href="#about" className="footer-link text-gray-400 text-sm sm:text-base">Home</a></li>
            ...
            >
              ...
              <ul className="space-y-2">
                <li><a href="#" className="footer-link text-gray-400 text-sm sm:text-base">Video Editing</a></li>
                <li><a href="#" className="footer-link text-gray-400 text-sm sm:text-base">Thumbnail Design</a></li>
                <li><a href="#" className="footer-link text-gray-400 text-sm sm:text-base">Script Writing</a></li>
                <li><a href="#" className="footer-link text-gray-400 text-sm sm:text-base">Content Creation</a></li>
              </ul>
            </div>
            ...
            >
              ...
              <div className="flex flex-col gap-2">
                ...
                />
                <button onClick={handleSubscribe} className="newsletter-button px-4 sm:px-6 py-2 rounded-full text-black font-semibold text-sm sm:text-base">
                  Subscribe
                </button>
              </div>
            </div>
          ...
          >
            ...
            <div className="flex flex-wrap justify-center gap-4 sm:gap-6 text-xs sm:text-sm">
              <a href="#" className="footer-link text-gray-400">Privacy Policy</a>
              <a href="#" className="footer-link text-gray-400">Terms of Service</a>
              <a href="#" className="footer-link text-gray-400">Cookie Policy</a>
            </div>
          </div>
        </div>
      </div>
